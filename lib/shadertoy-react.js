...
var processUniform = function processUniform(gl, location, type, value) {
  switch (type) {
    ...
    default:
      console.warn("ShaderToyReact: The uniform type ".concat(type, " is not valid, please make sure your type is valid"));
      break;
  }
};
var uniformTypeToGLSLType = function uniformTypeToGLSLType(type) {
  switch (type) {
    ...
    default:
      console.error("ShaderToyReact: The uniform type \"".concat(type, "\" is not valid, please make sure your uniform type is valid"));
  }
};
